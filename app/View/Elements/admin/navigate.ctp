<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/doctruyen/admin/dashboards">Manager</a>
    </div>
    <!-- /.navbar-header -->
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/doctruyen/admin/users/list">List</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/doctruyen/admin/categories/list">List</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#"><i class="fa fa-book fa-fw"></i> Story<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/doctruyen/admin/stories/list">List</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/doctruyen/admin/chapters/list">Chapter</a>
                        </li>
                        <li>
